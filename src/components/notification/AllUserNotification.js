                                        ...
                                        <div className="table-container mb-3" style={{ overflowX: 'auto' }}>
                                            <div className="row mb-3">
                                                ...
                                                <div className="col-lg-3">
                                                    <Link className='text-white btn btn-primary btn-lg' to={`/list-of-all-notification`}>List Of All Notification</Link>
                                                </div>
                                            </div>
                                            <div className="row">
                                                <div className='col-lg-12 mb-4'>
                                                    <form className="login-form" onSubmit={handleFormSubmit}>
                                                        <div className="form-outline mb-4">
                                                            <label className="form-label" htmlFor="prizePool">Title</label>
                                                            <input
                                                                type="text"
                                                                id="prizePool"
