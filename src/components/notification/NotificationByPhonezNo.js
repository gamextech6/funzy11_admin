    ...
    <div>
      <body id="page-top">
              ...
              <div className="container-fluid">
                <div className="row">
                  <div className='col-lg-12'>
                    <div className="table-container mb-3" style={{ overflowX: 'auto' }}>
                      <div className="row mb-3">
                        <div className="col-lg-2">
                          <h5 className="mt-2">Add Notification By Phone No.</h5>
                        </div>
                        <div className="col-lg-3">
                          <Link className='text-white btn btn-primary btn-lg' to={`/list-of-all-notification-specific-user`}>List Of All Notification</Link>
                        </div>
                      </div>
                      <div className="row">
                        <div className='col-lg-12 mb-4'>
                          <form className="login-form" onSubmit={handleFormSubmit}>
                            <div className="form-outline mb-4">
                              <label className="form-label" htmlFor="prizePool">Phone No.</label>
                              <input
                                type="text"
                                id="prizePool"
                            ...
                            <div className="form-outline mb-4">
                              <label className="form-label" htmlFor="entryFee">Title</label>
                              <input
                                type="text"
                                id="entryFee"
                            ...
                            <div className="form-outline mb-4">
                              <label className="form-label" htmlFor="entryFee">Message</label>
                              <input
                                type="text"
                                id="entryFee"
        ...
        >
          ...
          <button onClick={closeModal} style={{ width: "100px" }}>Ok</button>
        </Modal>
      </body>
    </div>
  )
